...
namespace AngularAuthAPI
{
    public class Startup
    {
        ...
        public object builder { get; private set; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Data.UserDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("connectionString")));
